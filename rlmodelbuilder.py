...
class RLModelBuilder:
    ...
    def __init__(self, input_shape: tuple, output_shape: tuple):
        ...
        * v represents the value of the given state s.
        """
    ...
    def build_convolutional_layer(self, input_layer) -> KerasTensor:
        ...
        layer = Conv2D(filters=self.convolution_filters, kernel_size=(3, 3), strides=(
            1, 1), padding='same', data_format='channels_last', use_bias=False)(input_layer)
    ...
    def build_residual_layer(self, input_layer) -> KerasTensor:
        ...
        layer = Conv2D(filters=self.convolution_filters, kernel_size=(3, 3), strides=(
            1, 1), padding='same', data_format='channels_last', use_bias=False)(layer)
        layer = BatchNormalization(axis=1)(layer)
        # skip connection
    ...
    def build_policy_head(self) -> Model:
        ...
        model.add(Conv2D(2, kernel_size=(1, 1), strides=(1, 1), input_shape=(19, 8, 256), padding='same', data_format='channels_last'))
